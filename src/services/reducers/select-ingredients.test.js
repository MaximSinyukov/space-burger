...
describe("selectIngredients reducer", () => {
  ...
  it("should handle selectIngredient action", () => {
    expect(reducer({ ...initialState, otherIngredients: [payloadIngredients[0]] }, selectIngredient(payloadIngredients[1])))
      .toEqual({
        ...initialState,
  ...
  it("should handle removeIngredient action", () => {
    expect(reducer({ ...initialState, otherIngredients: payloadIngredients }, removeIngredient('1')))
      .toEqual({
        ...initialState,
  ...
  it("should handle updateOtherIngredients action", () => {
    expect(reducer({ ...initialState, otherIngredients: [payloadIngredients[0]] }, updateOtherIngredients(payloadIngredients)))
      .toEqual({
        ...initialState,
        otherIngredients: payloadIngredients,
      });
  ...
  it("should handle selectBuns action", () => {
    expect(reducer(initialState, selectBuns(payloadIngredients[0])))
      .toEqual({
        ...initialState,
  ...
  it("should handle increaseIngredientCount action", () => {
    expect(reducer(initialState, increaseIngredientCount('test1')))
      .toEqual({
        ...initialState,
        ingredientsCounter: {
          test1: 1,
  ...
  it("should dispatch action in mock store", () => {
    ...
    expect(store.getActions()[0])
      .toEqual(selectIngredient(payloadIngredients[1]));
  });
});
