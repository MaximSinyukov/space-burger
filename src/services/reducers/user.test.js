...
describe("user reducer", () => {
  ...
  it("should handle setUserAuthorization action", () => {
    expect(reducer(initialState, setUserAuthorization()))
      .toEqual({
        ...initialState,
        isAuthorized: true,
      });
  ...
  it("should handle setUserUnuthorization action", () => {
    expect(reducer({ ...initialState, isAuthorized: true }, setUserUnuthorization()))
      .toEqual({
        ...initialState,
        isAuthorized: false,
      });
  ...
  it("should handle setUserData action", () => {
    expect(reducer(initialState, setUserData(payloadUserData)))
      .toEqual({
        ...initialState,
  ...
  it("should handle removeUserData action", () => {
    expect(reducer({ ...initialState, userData: payloadUserData }, removeUserData()))
